...
It's natural a `gtsummary` user would want to customize the aesthetics
of the table with one or more of the many `gt` functions available. `gt` is the table equivalent of `ggplot2`; very powerful and you can change/customize just about everything. 
